...
function dateRegex(sentence) {
    const regexPattern = "\b(?:mon|tue|wed|thurs|fri|sat|sun|monday|tuesday|wednesday|thursday|friday|saturday|sunday|today|tonight)\b\s(?:at|@)\s((:0?[0-9]|1[0-9]|2[0-4])(?::[0-5][0-9])?)\s?(am|pm)?";
